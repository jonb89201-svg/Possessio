...
contract MockV3Router {
        ...
        external returns (uint256 amountOut)
    {
        ...
        // forge-lint: disable-next-line erc20-unchecked-transfer — Mock V3 router stub for testing; production PossessioPayments uses SafeERC20 internally and approves a real V3 router on Base mainnet.
