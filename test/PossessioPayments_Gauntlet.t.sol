...
contract MockV3Router_G {
        ...
        external returns (uint256 amountOut)
    {
        ...
        // forge-lint: disable-next-line erc20-unchecked-transfer — Mock V3 router stub for adversarial testing (dangling-approval scenario); production PossessioPayments uses SafeERC20 and approves a real V3 router on Base mainnet.
