...
contract PLATETest is Test {
    ...
    /// @dev Spot price returns valid result with 10-second window
    function test_SpotPrice_10SecondWindow() public {
        // Pool ticks set in setUp reflect reference price
