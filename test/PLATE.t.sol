...
contract PLATETest is Test {
    ...
    function testFuzz_Invariant_SymmetryGuard(uint256 tickManipulation) public {
        ...
        // Bound manipulation within int56 range to prevent cast overflow
        // int56 max = 2^55 - 1 = 36028797018963967
        tickManipulation = bound(tickManipulation, 1, 36028797018963967);

        // Set ticks to create extreme divergence (spot != TWAP)
        pool.setTicks(int56(-int256(tickManipulation)), int56(0));
