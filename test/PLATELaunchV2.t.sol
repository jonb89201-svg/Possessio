...
contract PLATELaunchV2Test is Test {
    ...
    function test_Launch_FirstLegitimateFeeSwapAfterBootstrap() public {
        ...
        require(plate.transfer(address(pool), needed), "PLATELaunchV2.t.sol:409 transfer must succeed");
        ...
        require(plate.transfer(address(router), 5_000_000 * 1e18), "PLATELaunchV2.t.sol:428 transfer must succeed");
