...
contract MockV3RouterAttack {
        ...
        external payable returns (uint256 amountOut)
    {
        ...
        if (params.tokenIn == weth && params.amountIn > 0) {
            // Mock V3 router stub for adversarial testing; production hook approves and uses SafeERC20-equivalent V3 router on Base mainnet.
...
contract POSSESSIOv2Gauntlet is Test {
    ...
    function test_Attack_RescueCannotDrainSTEEL() public {
        ...
        // Test fixture seeding; STEEL inherits OpenZeppelin ERC20 which reverts on failure; if transfer silently failed, the rescue assertion below would catch it.
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
    ...
    function test_Attack_RescueUnlistedTokenSucceeds() public {
        ...
        vm.prank(TREASURY);
        // Test fixture seeding; STEEL ERC20 reverts on failure; balance assertion below catches any silent failure.
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
    ...
    function test_Attack_SAVSlashedBlocksAllOps() public {
        ...
        // Test fixture seeding; STEEL ERC20 reverts on failure; subsequent savDeposit asserts state.
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
        ...
        // Test fixture seeding; STEEL ERC20 reverts on failure; subsequent expectRevert asserts state.
        // forge-lint: disable-next-line(erc20-unchecked-transfer)
