 ...
 *
 *  Council-ratified invariant tests for POSSESSIO_v2-6-1.sol.
...
import {PossessioHook, STEEL} from "../src/POSSESSIO_v2-6-1.sol";
...
contract POSSESSIO_v2_Invariants_t is Test {
    ...
    function setUp() public virtual {
        ...
        daiFeed    = new MockChainlink(8);   // v2.6.1 — 8-decimal price-feed
