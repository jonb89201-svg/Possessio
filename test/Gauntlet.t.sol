...
contract PLATEAttackTest is Test {
    ...
    // LPFailed(ethForLP, 3) must emit, ETH stays isolated
    // ============================================================
    function test_Attack_LP_SlippageBreach_ZeroPlateReturned() public {
        ...
        // ethForLP = 50% of LP allocation = 50% of 25% of 4 ETH = 0.5 ETH
        vm.expectEmit(false, false, false, true);
        emit PLATE.LPFailed(0.5 ether, 3);
    ...
    function test_Attack_LP_NoPriceAvailable() public {
        ...
        // LP allocation = 25% of 4 ETH = 1 ETH
        // LPFailed(ethAmt, 5) where ethAmt = toLp = 1 ETH
        vm.expectEmit(false, false, false, true);
