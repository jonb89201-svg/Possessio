...
contract PLATELaunchTest is Test {
    ...
    function test_Launch_FirstLegitimateFeeSwapAfterBootstrap() public {
        ...
        uint256 expectedLpRemainder = preRouteBalance * 25 / 100;

        assertApproxEqAbs(address(plate).balance, expectedLpRemainder, 0.001 ether,
            "LP isolation failed: incorrect ETH retention after routeETH");
