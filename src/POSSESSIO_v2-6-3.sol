 ...
 * ╚═╝     ╚══════╝╚═╝  ╚═╝   ╚═╝   ╚══════╝
 *
 * POSSESSIO PROTOCOL — v2.6.4 (STEEL + Chainlink Automation + Aerodrome cbETH route)
 * Protocol Liquidity Asset Treasury Engine, rebuilt as Uniswap V4 hook
 *
 * v2.6.4 (2026-05-30) — Size + green reduction: revert the v2.6 -> v2.6.3
...
///         discriminator (Uniswap V3 uses uint24 fee).
    /// @dev    v2.6.4 — Router address and exactInputSingle selector CONFIRMED
...
contract PossessioHook is IUnlockCallback, ReentrancyGuard, Ownable2Step, AutomationCompatibleInterface {
    ...
    function routeETH() external nonReentrant notPaused {
        ...
        // --- v2.6.4 direct dispatch (X-LINK self-heals on revert) ---------
    ...
    function _routeETH(uint256 secret) internal {
        ...
        // --- v2.6.4 slippage computed here at execution time --------------
        ...
        // the predicate here). v2.6.4 uses msg.sender directly: with direct
        ...
        returns (bool upkeepNeeded, bytes memory performData)
    {
        ...
        // ROUTE_ETH branch -- v2.6.4: encode task discriminator only. Slippage
        ...
        nonReentrant
    {
        ...
        // v2.6.4 -- performData carries only the task discriminator (carry-through retired).
        ...
        if (task == UpkeepTask.ROUTE_ETH) {
            ...
            // v2.6.4 -- direct dispatch. msg.sender inside _routeETH is the
