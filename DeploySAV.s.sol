 ...
 *   1. PLATEStaking deployed at 0x35A7Aa7baBAdAec2c56C5b3ab8A03077D862f4F4
 *   2. DEPLOY THIS SCRIPT — SAV
 *   3. Treasury Safe calls PLATEStaking.setSAV(SAV_ADDRESS) via multisig
 *
 * PRE-DEPLOYMENT CHECKLIST:
 *   [x] PLATEStaking deployed and address captured
 *   [x] STAKING constant below updated with deployed PLATEStaking address
 *   [x] Council addresses verified against source of truth
 *   [x] Treasury Safe confirmed as 3-of-5 multisig owner
 *
 * Usage:
 ...
 *       0x35A7Aa7baBAdAec2c56C5b3ab8A03077D862f4F4 \
...
contract DeploySAV is Script {
    ...
    // ── PLATEStaking (deployed mainnet) ───────────────────────────
    // Deployed and verified on Base mainnet
    // https://basescan.org/address/0x35A7Aa7baBAdAec2c56C5b3ab8A03077D862f4F4
    address constant STAKING   = 0x35A7Aa7baBAdAec2c56C5b3ab8A03077D862f4F4;
