...
contract PLATEAttackTest is Test {
    ...
    function test_Attack_ForceInjectedETH() public {
        ...
        // All ETH correctly routed to LP and staking — no stranding
        // Treasury receives yield later via harvestYield(), not directly here
        assertLt(address(plate).balance, 0.01 ether,
            "All ETH must be routed - none stranded after force injection");
    }
