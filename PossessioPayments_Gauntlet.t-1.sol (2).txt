...
import "../src/PossessioPayments_v2-4-1.sol";
...
contract PossessioPaymentsGauntlet is Test {
    ...
    function setUp() public {
        ...
        // v2.4.1 — Oracle scale migrated:
        //   cbETH/ETH: 18-decimal exchange-rate, 0.98e18 healthy peg
        //   DAI/ETH:   8-decimal price-feed retained
        ...
        // v2.4.1 — 14-param constructor (was 11). New: weth, aeroRouter, morphoVault.
        payments = new PossessioPayments(
            ...
            address(weth),         // v2.4.1
            address(router),
            address(aeroRouter),   // v2.4.1
            address(morphoVault),  // v2.4.1
