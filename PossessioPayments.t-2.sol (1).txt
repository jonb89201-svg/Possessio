...
contract PossessioPaymentsAutomationTest is Test {
    ...
    function test_CheckUpkeep_FalseDuringSweepDelay() public {
        ...
        // Refresh oracle prices after the time skip -- setAnswer() also
        // refreshes _updatedAt on this mock, restoring oracle freshness so
        // _validateOracle does not revert with OracleStale.
