...
/*===============================================================================
  ...
  authored against verified POSSESSIO_v2-6-1.sol (V3) and PossessioPayments_v2-4-1.sol (V3) source signatures.
...
import {PossessioHook} from "../src/POSSESSIO_v2-6-1.sol";
import {STEEL}         from "../src/POSSESSIO_v2-6-1.sol";
import {PossessioPayments} from "../src/PossessioPayments_v2-4-1.sol";
...
contract PaymentsAutomationInvariants is Test {
    ...
    function setUp() public virtual {
        ...
        ethOracle   = new MockChainlink_A(18);  // V3 — cbETH/ETH 18-dec
        daiOracle   = new MockChainlink_A(8);   // V3 — DAI/ETH 8-dec
        lstRates    = new MockLSTRates_A();

        // V3 — 14-param constructor with weth/aeroRouter/morphoVault inserted
        payments = new PossessioPayments(
            ...
            address(weth),         // V3
            address(router),
            address(aeroRouter),   // V3
            address(morphoVault),  // V3
            address(ethOracle),
            address(daiOracle),
            address(lstRates),
            MIN_SWAP_BATCH,
