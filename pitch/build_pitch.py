...
<div class="wrap">
  ...
  <section class="block">
    ...
    <div class="systems">
      ...
      <div class="card">
        ...
        <p>A deterministic, non-custodial protocol on Base with an Ethereum-L1 settlement extension: Uniswap V4 hooks (CREATE3 salt-mined, bytecode-independent addresses), Chainlink Automation, a per-merchant institutional-settlement architecture. Three contracts live on mainnet; the rest fork-proven behind a green gate.</p>
        <div class="tags"><span class="tag">Solidity</span><span class="tag">Foundry</span><span class="tag">Uniswap V4</span><span class="tag">Chainlink</span><span class="tag">CREATE3</span></div>
      </div>
      ...
      <div class="card">
        ...
        <p>A self-running measurement worker that watches new-token births on a 60-second cadence, tracks each one's price trajectory, and detects graduation to real liquidity. It corrects its own measurement biases and has run unattended for days &mdash; tens of thousands of tokens tracked and counting.</p>
        <div class="tags"><span class="tag">Workers cron</span><span class="tag">D1</span><span class="tag">live data pipeline</span><span class="tag">self-correcting</span></div>
      </div>
  ...
  <section class="block">
    ...
    <div class="readout">
      ...
      <div class="stat wide"><div class="num"><em>100%</em> mobile</div><div class="lbl">Every commit, test &amp; deploy routed through a phone</div></div>
    </div>
  </section>
