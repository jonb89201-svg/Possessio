...
contract PossessioPayments is AccessControl, ReentrancyGuard, AutomationCompatibleInterface {
    ...
    function sweep(
        ...
        // it immediately before the internal call. _sweep verifies + consumes.
        uint256 secret = ++_executionNonce;
        _activeExecutionSecret = secret;

        _sweep(minDaiOut, minCbEthOut, secret);
    }
        ...
        nonReentrant
    {
        ...
        // Secure-Context-Handshake: mint a monotonic one-time secret and arm
        // it immediately before the internal call. onlyForwarder + nonReentrant
        // remain this path's authorization and reentrancy guards; the handshake
        // is the additional proof that _sweep was reached through this branch.
        uint256 secret = ++_executionNonce;
        _activeExecutionSecret = secret;
