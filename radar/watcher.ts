...
export type WatcherEnv = Env & {
  ...
  STRAT_TARGET_PCT?: string;  // go-to strategy: take-profit as fraction over entry (default 0.50 — let winners run)
  STRAT_STOP_PCT?: string;    // go-to strategy: stop-loss as fraction under entry (default 0.40)
  BASE_RPC_URL?: string;
